...
###############################################
## KATA 06: Escribe una función que calcule el factorial de un número de manera recursiva.
...
## Para usar reduce, es necesario importarla desde el módulo functools
...
titulo_kata(34)
mi_arbol = Arbol()
Arbol.crecer_tronco(mi_arbol)
Arbol.nueva_rama(mi_arbol)
Arbol.crecer_ramas(mi_arbol)
Arbol.nueva_rama(mi_arbol)
Arbol.nueva_rama(mi_arbol)
Arbol.quitar_rama(mi_arbol, 1)
print(f"Información del árbol: {Arbol.info_arbol(mi_arbol)}")
...
def calcular_precio_final():
    try:
        ...
        descuento = input("¿Tiene un código de descuento? (si/no): ").strip().lower()
        ...
        print("Error: Por favor, ingrese un valor numérico válido para el precio y el descuento.")
